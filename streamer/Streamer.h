...
namespace Streams
{
    ...
    private:
        ...
        void InitializeComponent(void)
        {
			...
			//cli::array<System::Object ^>  __mcTemp__1 = gcnew cli::array< System::Object^  >(10);// gcnew System::Object*[10];
            //__mcTemp__1[0] = L"1";
            //__mcTemp__1[1] = L"2";
            //__mcTemp__1[2] = L"4";
            //__mcTemp__1[3] = L"8";
            ...
            this->RateGroupBox->Text = L" Transfer Rate (KB/s) ";
            // 
            // RateLabel
            // 
            ...
            //System::Object^ __mcTemp__2[] = gcnew System::Object*[7];
            //__mcTemp__2[0] = L"1";
            //__mcTemp__2[1] = L"2";
            //__mcTemp__2[2] = L"4";
            //__mcTemp__2[3] = L"8";
            ...
            this->SuccessLabel->Text = L"SuccesseL";
            ...
            this->FailureLabel->Text = L"FailureL";
            ...
            //this->Icon = (__try_cast<System::Drawing::Icon*  >(resources->GetObject(L"$this.Icon")));
            this->Name = L"Form1";
            this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
            this->Text = L"C++ Streamer";
        ...
        void GetStreamerDevice()
        {
            ...
            for (int i=0; i<n; i++)
            {
				...
				String^ fn = gcnew String(USBDevice->FriendlyName);
                strDeviceData = String::Concat(strDeviceData, fn);               
        ...
        void StartBtn_Click(System::Object ^  sender, System::EventArgs ^  e)
        {
            ...
            if (XferThread) {
                ...
                case System::Threading::ThreadState::Unstarted:
                    ...
                    if (EndPt == NULL ) EndPointsBox_SelectedIndexChanged(NULL, System::EventArgs::Empty);
                    ...
                    if ((XferThread->ThreadState) == System::Threading::ThreadState::Stopped)
						//ThreadStart ^ param = gcnew ThreadStart(XferLoop);
                        XferThread = gcnew Thread(gcnew ThreadStart(XferLoop));
        ...
        void DeviceComboBox_SelectedIndexChanged(System::Object ^  sender, System::EventArgs ^  e)
        {
            ...
            {
                EndPointsBox->SelectedIndex = 0;
                EndPointsBox_SelectedIndexChanged(NULL, System::EventArgs::Empty);
                StartBtn->Enabled = true;
            }
            else
                StartBtn->Enabled = false;
